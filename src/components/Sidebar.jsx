  ...
  return (
    <div className="d-flex flex-column p-3 sidebar" >
      <ul className="nav nav-pills flex-column mb-auto" >
        ...
        <li>
          <Link to="/results/music" className="nav-link">
            <FaMusic className="me-2" /> Music
          </Link>
        </li>
        <li>
          <Link to="/results/gaming" className="nav-link">
            <FaGamepad className="me-2" /> Gaming
          </Link>
        </li>
        <li>
          <Link to="/results/technology" className="nav-link">
            <FaLaptopCode className="me-2" /> Technology
          </Link>
        </li>
      </ul>
    </div>
